            ...
            <div>
              ...
              <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "1rem" }}>
                {[
                  ...
                  { icon: Phone, text: "0549 900 98 91" },
              ...
              <a
                ...
                style={{
                  ...
                  textDecoration: "none",
                  transition: "all 0.3s ease",
                  boxShadow: "0 2px 8px rgba(15,32,96,0.25)",
                }}
                onMouseEnter={(e) => {
                  (e.currentTarget as HTMLAnchorElement).style.transform = "translateY(-2px)";
                  (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 6px 20px rgba(15,32,96,0.35)";
                }}
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLAnchorElement).style.transform = "translateY(0)";
                  (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 2px 8px rgba(15,32,96,0.25)";
                }}
              >
                <Phone size={15} />
                0549 900 98 91
